...
import com.justai.jaicf.template.trainer.ExcerciseType
...
class Running(val level: Int = 0, val prevExcercise: ExcerciseType? = null, val trainingStartTime: LocalTime) :
    State() {
...
//        }
        ...
        alice.say(text = "C начала трени прошло ${currentDuration.seconds}. $title")

        val imageGallery: ImageGallery = alice.ImageGallery()
        nextExcercise.imageIds.forEach { a -> imageGallery.addImage(Image(a)) }

        alice.say("музыка", tts = "<speaker audio=\"dialogs-upload/a80c89a2-d508-4008-9a33-6a8dc12e2895/0d7f80a5-815f-4b0b-9855-40fedaec04ab.opus\">")
