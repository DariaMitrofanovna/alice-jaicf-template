...
class Training(private val level: Int, private val startTime: Long, val excercise: Excercise) : State() {
    ...
    override fun handleInternal(request: BotRequest, alice: AliceReactions): State {
        ...
        alice.say(
            RandomPhrase(
                "Круто, справились за $time секунд. Побежали дальше! Еще минута бега! Скажи, когда закончишь.",
                "А вы спортсмен! Всего $time секунд. Еще минута бега! Скажи, когда закончишь.",
                "$time секунд на упражнение, отлично, в путь! Еще минута бега! Скажи, когда закончишь."
            ).random
        )
        alice.buttons(
            "Еще упражнений",
